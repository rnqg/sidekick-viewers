    ...
    while True:
        ...
        try:
            ...
            args = [
                ...
                "--disable-background-timer-throttling", "--disable-features=ScriptStreaming",
            ...
            print(f"session {sid} started, mem_free: {psutil.virtual_memory().available // 1024**2}MB")
            ...
            while True:
                ...
                try:
                    ...
                    if refresh_count % 100 == 0:
                        ...
                        print(f"session {sid}: {refresh_count} refreshes, mem_free: {mem_free}MB")
            ...
            print(f"critical error in session {sid}: {e.__class__.__name__}. restarting in 10s.")
        finally:
            if driver:
                try: driver.quit()
                except: pass
...
def main():
    ...
    parser.add_argument("-n", "--browsers", type=int, default=2, help="Number of browser instances")
    parser.add_argument("-m", "--min-mem", type=int, default=2, help="Min free RAM in GB to launch")
